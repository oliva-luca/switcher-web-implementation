...
def list_of_games():
    return [
        {'id_partida': 1, 'name': 'game1', 'cant_jugadores': 1, 'started': False, 'is_private': False, 'password': 'as', 'turn' : None, 'id_tablero': 1, 'players': [], 'movcards' : [], 'figcards' : []},
        {'id_partida': 2, 'name': 'game2', 'cant_jugadores': 3, 'started': True, 'is_private': False, 'password': 'as', 'turn' : None, 'id_tablero': None, 'players': [], 'movcards' : [], 'figcards' : []},
        {'id_partida': 3, 'name': 'game3', 'cant_jugadores': 4, 'started': False, 'is_private': False, 'password': 'as', 'turn' : None, 'id_tablero': None, 'players': [], 'movcards' : [], 'figcards' : []},
        {'id_partida': 4, 'name': 'game4', 'cant_jugadores': 3, 'started': False, 'is_private': False, 'password': 'as', 'turn' : None, 'id_tablero': None, 'players': [], 'movcards' : [], 'figcards' : []},
